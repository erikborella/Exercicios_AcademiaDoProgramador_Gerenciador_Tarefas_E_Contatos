...
namespace ControleDeTarefas.Controladores.Legado
{
    public class ControladorTarefa : ControladorBase<Tarefa>
    {
        ...
        protected override Tarefa LerRegistro(IDataReader leitor)
        {
        ...
        private PrioridadeTarefa PegarPrioridade(IDataReader leitor)
        {
        ...
        private DateTime? PegarDataConclusao(IDataReader leitor)
        {
